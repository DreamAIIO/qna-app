'''
The credit for most of this code goes to: DashyDashyOrg - `https://github.com/DashyDashOrg`

The source code can be found at: `https://github.com/DashyDashOrg/pandas-llm/blob/main/pandas_llm/__init__.py`

I have only made changes to to allow using the updated openai python library (openai v1+) which the
original code did not allow.

TODO: Use an opensource LLM like StarCoder or Llama2 or Mistral etc. to generate code with provision
for OpenAI Chat Models as well using LangChain.
'''
...
class PandasLLM(pd.DataFrame):
    ...
    llm_default_model = "gpt-4-1106-preview" #"gpt-3.5-turbo"
